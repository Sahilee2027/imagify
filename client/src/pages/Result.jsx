...
const Result = () => {
  ...
  const [isImageLoaded,setIsImageLoaded]=useState(false); //it is for if image is generated then render this div else this one
  const[loading,setLoading]=useState(false);          //this is for loading image
  const [input,setInput]=useState('');                //to store input data
